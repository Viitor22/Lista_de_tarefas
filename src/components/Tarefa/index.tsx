...
import tarefas, { remover, editar, alteraStatus } from '../../store/reducers/tarefas'
    ...
    return (
        <S.Card>
            <label htmlFor={titulo}>
                <input checked={status === enums.Status.CONCLUIDA} onChange={alteraStatusTarefa} type="checkbox" id={titulo} />
                <S.Titulo>
            ...
            <S.Descricao disabled={!estaEditando} value={descricao} onChange={evento => setDescricao(evento.target.value)}></S.Descricao>
            <S.BarraAcoes>
                {estaEditando ? (
                    <>
                        <BotaoSalvar onClick={() => {
